...
function App() {
  ...
  const pilotTakenByOther = players.some(
    ([playerUid, player]) =>
      playerUid !== userId &&
      ...
      <main className="home">
        <section className="panel">
          ...
          <p className="description">
            Choose your station for the Apollo 13 course correction.
          </p>
          ...
          <div className="role-grid">
            <button
              type="button"
              className="role-card"
              disabled={pilotTakenByOther || loading}
              onClick={() => chooseRole("astronaut")}
            >
              <span className="role-icon">🛰️</span>
              <strong>SPACECRAFT PILOT</strong>

              <small>
                {pilotTakenByOther
                  ? "ROLE TAKEN"
                  : "Fly and align the spacecraft"}
              </small>
            </button>
            ...
            >
              ...
              <small>
                {engineerTakenByOther
                  ? "ROLE TAKEN"
                  : "Manage power, guidance, cooling, and engines"}
              </small>
            </button>
          </div>
  ...
  return (
    <main className="home">
      <section className="hero">
        ...
        <p className="description">
          Cooperate as a spacecraft pilot and systems engineer
          to survive critical moments from historic space missions.
        </p>
